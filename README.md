...
=======
| [Azure Hub-Spoke Design](#azure-hub-spoke-design)     | Thu, Feb 23rd 2023 12-1pm ET | Tommy Falgout (Sr. Cloud Solution Architect), Jose Moreno (Principal Customer Engineer), Heather Sze (Principal Security Cloud Solution Architect)   | David O'Keefe(Partner Technology Strategist),Nehali Neogi (Cloud Solution Architect)| TBD |
